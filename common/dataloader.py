...
def load_dataset(
    ...
    for dataname in entities:
        with open(
            ...
            train = pickle.load(f).reshape((-1, dim))[0:train_nrows, :]
            if valid_ratio > 0:
        ...
        with open(
            ...
            test = pickle.load(f).reshape((-1, dim))[0:test_nrows, :]
        ...
        with open(
            ...
            data[dataname]["test_label"] = pickle.load(f).reshape(-1)[0:test_nrows]

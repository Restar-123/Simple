    ...
    def __init__(self, input_dim: int, dilation_rate: int, nb_filters: int, kernel_size: tuple,
        ...
        if padding == 'causal':
            ...
            self.conv2 = torch.nn.Sequential(
                ...
                torch.nn.Conv1d(nb_filters, nb_filters, kernel_size=kernel_size2, dilation=dilation_rate, padding=0)
            )
        else:
            self.conv1 = torch.nn.Conv1d(input_dim, nb_filters, kernel_size=kernel_size1, dilation=dilation_rate,
                                         padding=padding)
            self.conv2 = torch.nn.Conv1d(nb_filters, nb_filters, kernel_size=kernel_size2, dilation=dilation_rate,
                                         padding=padding)

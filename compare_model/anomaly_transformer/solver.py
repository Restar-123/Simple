...
class AnomalyTransformer(nn.Module):
    ...
    def fit(self, train_loader, val_loader,epochs,lr,criterion=nn.MSELoss()):
        ...
        for epoch in range(self.num_epochs):
            ...
            self.model.train()
            for i, input_data in tqdm(enumerate(self.train_loader)):
    ...
    # def predict_prob(self, test_loader, window_labels=None):
    ...
    #         anomaly_score = anomaly_score * 1e3
    #         logging.info("mse:" + str(anomaly_score.mean()))
    #
    #         if window_labels is not None:
    #             window_labels = (np.sum(window_labels, axis=1) >= 1) + 0
    #             return anomaly_score, window_labels
    #         else:
